...
[Live Demo]( https://www.cohesionet.com/web/ui/actor/demo)
...
3. [Register your store for account ID](https://www.cohesionet.com/web/ui/actor/widgets?co_uiRole=register&co_hostID=wooCommerce) 
...
1. Go to [Cohesionet Home](https://www.cohesonet.com), use your store administrator account login; 
...
= 1.0.8 =
The minor release for bug fixes
