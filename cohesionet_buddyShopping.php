...
* Description: Connect people for shopping together and offer built-in sales support, instant and effective. To get started: 1) Click the "Activate" link to the left of this description, 2) <a href="https://www.cohesionet.com/web/ui/actor/widgets?co_uiRole=register&co_hostID=wooCommerce">Register for store account ID</a>, and 3) Go to your Cohesionet- BuddyShopping configuration page, and save your account ID.
* Version: 2.0.0
* Author: Cohesionet
